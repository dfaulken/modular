...
module Modular
  class << self
    ...
    # This prime factorization should be in the format
    # of that given by Modular#factor.
    # Example:
    ...
    # Returns the elements of integers in the
    # given modulus which are quadratic residues.
    # Example:
